...
<figure class="single-product__after_thumb">
	<img src="data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="<?php echo $sale_image['url'] ?>" alt="<?php echo $sale_image['alt'] ?>" title="<?php echo $sale_image['title'] ?>" class="lazyload single-product__after_thumb--img"/>
</figure>
	</a>
<?php 
	endif;
