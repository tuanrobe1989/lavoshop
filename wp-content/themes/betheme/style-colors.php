...
.grid .post-item{
	background-color: <?php echo esc_attr(mfn_opts_get('background-archives-post', '#fff')) ?>;
}
.portfolio_group .portfolio-item .desc{
	background-color: <?php echo esc_attr(mfn_opts_get('background-archives-portfolio', '#fff')) ?>;
}
...
.woocommerce .comment-form-rating p.stars a:before, .wishlist .wishlist-row .price, .mfn-wish-button:not(.link) .icon-heart-fa {
...
.woocommerce span.onsale.onsale-label, .fake-tabs > ul li a:after, .fake-tabs > ul li a .number{
...
.woocommerce #reviews #comments ol.commentlist li .comment-text p.meta .woocommerce-review__author{color:<?php echo esc_attr(mfn_opts_get('color-h4', '#161922')); ?>}
