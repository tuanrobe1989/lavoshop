...
class MFN_Options_upload_icon extends Mfn_Options_field
{
	...
	public function upload_icons()
	{
		...
		$wp_upload_file = ABSPATH . str_replace(get_home_url($this->value).'/', '', $this->value);
		...
		$new_icon_url = wp_normalize_path( get_home_url() . '/wp-content/uploads/'. get_stylesheet() .'/icons/' . $font_name_provided);
