                ...
                <div class="invoice_row">
                    <div class="invoice_header">
                        <div class="invoice_logo">
                            ...
                            <?php else:?>
                                <div class="no-print">Thay logo tại WP Admin -> Woocommerce -> Cài đặt GHTK -> Cài đặt in hóa đơn -> Logo. (Thông báo này sẽ không hiển thị khi in)</div>
                            <?php endif;?>
                        </div>
                ...
                <div class="invoice_row">
                    <div class="invoice_total">
                        <div class="invoice_total_left">
                            ...
                            ?>
                            <span class="total_price"><?php echo ($is_freeship) ? wc_price(intval($ghtk_order['order']['pick_money'])) : wc_price(intval($ghtk_order['order']['pick_money']) + intval($ghtk_status['order']['fee']) + intval($ghtk_status['order']['insurance_fee']));?></span>
